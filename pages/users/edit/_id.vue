            ...
            <v-card class="mb-2">
                ...
                <v-card-text>
                    ...
                    <v-form ref="form">
                        ...
                        <v-text-field name="email" label="Email" type="email" :rules="rules.email"
                            v-model="form.email" />
                        <v-text-field name="password" label="Password" type="password" :rules="rules.password"
                            v-model="form.password" />
                        <v-text-field name="retype_password" label="Re-Password" type="password"
                            :rules="rules.retype_password" v-model="form.retype_password" />
                        <v-select name="role" label="Role" type="text" :items="roles" :rules="rules.role"
                            v-model="form.role" />
                    </v-form>
                </v-card-text>
                <v-card-actions>
